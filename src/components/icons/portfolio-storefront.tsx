...
const PortfolioStoreFront: React.FC<SvgIconProps> = (props) => (
  <svg
    width="24"
    height="24"
    viewBox="0 0 24 24"
    ...
    {...props}
  >
    <g id="Storefront" clip-path="url(#clip0_675_4792)">
      <path
        id="Vector"
        d="M4.5 13.0859V19.4994C4.5 19.6983 4.57902 19.8891 4.71967 20.0297C4.86032 20.1704 5.05109 20.2494 5.25 20.2494H18.75C18.9489 20.2494 19.1397 20.1704 19.2803 20.0297C19.421 19.8891 19.5 19.6983 19.5 19.4994V13.0859"
        stroke="#161616"
...
export default PortfolioStoreFront;
