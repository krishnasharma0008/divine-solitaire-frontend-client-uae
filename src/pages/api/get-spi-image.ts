...
const createImage = async (
  ...
  <svg width="${width}" height="${height}">
    ...
    <svg x="65%" y="8%" height="800px" width="500px" class="percentage ${isMonthlyGrowth ? "green" : "red"}">
    ...
    <svg x="95%" y="8%" height="800px" width="500px" class="percentage ${isYearlyGrowth ? "green" : "red"}">
